      ...
      <div className="relative hidden md:flex md:w-1/2 lg:w-[55%] flex-col justify-end overflow-hidden">
        ...
        <div className="relative z-10 p-10 pb-12">
          ...
          <p className="text-white/75 text-sm leading-relaxed max-w-sm">
            Khám phá hàng ngàn bất động sản cao cấp và thông tin kiến trúc độc quyền dành riêng cho bạn.
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-1 items-center justify-center bg-white px-8 py-12 relative overflow-y-auto custom-scrollbar">
        ...
        <div className="w-full max-w-sm">
          ...
          <p className="text-sm text-gray-500 mb-8">
            {step === 1 ? 'Hãy cho chúng tôi biết thông tin cơ bản của bạn.' : 'Cài đặt mật khẩu để bảo vệ tài khoản.'}
          </p>
                ...
                <div className="min-h-[66px]">
                  <label className="flex items-start gap-2.5 cursor-pointer select-none">
                    ...
                    <span className="text-sm text-gray-600 leading-snug">
                      Tôi đồng ý với <a href="#" className="text-red-600 font-medium hover:underline">Điều khoản</a> và <a href="#" className="text-red-600 font-medium hover:underline">Chính sách</a> của Batdongsan.com.vn
                    </span>
                  </label>
          ...
          <div className="flex items-center gap-3 my-6">
            ...
            <span className="text-xs text-gray-400 uppercase tracking-widest whitespace-nowrap">Hoặc đăng ký với</span>
            <div className="flex-1 h-px bg-gray-200" />
          </div>

          {/* Social Buttons */}
          <div className="grid grid-cols-2 gap-3">
            <button disabled={loading} className="flex items-center justify-center gap-2 border border-gray-200 rounded-md py-2.5 text-sm text-gray-700 hover:bg-gray-50 transition font-medium disabled:opacity-50">
